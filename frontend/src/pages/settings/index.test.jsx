...
function baseMocks() {
  return [
    ...
    { request: { query: GET_MY_PATIENT_LINK }, result: { data: { me: { __typename: 'User', patient: null } } } },
    {
      ...
      result: { data: { bookingWidgetConfigs: [], webhookEndpoints: [{ __typename: 'WebhookEndpoint', id: WEBHOOK_ID, url: 'https://example.com/hook', event_types: ['appointment.created'], is_active: true }], apiKeys: [] } },
    },
  ]
}

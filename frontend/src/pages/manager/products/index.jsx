...
const MOCK_PRODUCTS = [
  {
    ...
    is_active: true,
    category: { id: 'pc-1', name: 'Supplements' },
    subcategory: null,
  },
  {
    id: 'prod-2',
    ...
    is_active: true,
    category: { id: 'pc-2', name: 'Pharmacy' },
    subcategory: null,
  },
  {
    id: 'prod-3',
    ...
    is_active: true,
    category: { id: 'pc-3', name: 'Equipment' },
    subcategory: null,
  },
  {
    id: 'prod-4',
  ...
  return (
    <Box>
      ...
      {tabIndex === 0 && (
        <>
          <Box mb={2}>
            <Button variant="contained" startIcon={<AddIcon />} onClick={() => navigate('/manager/products/new')}>
              Add Product
            </Button>
          </Box>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12} sm={6}>
                      <TextField
                        ...
                        label="Product Name"
                        value={pForm.name}
                        onChange={(e) => setFieldP('name', e.target.value)}
                      />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <TextField
                        ...
                        label="SKU"
                        value={pForm.sku}
                        onChange={(e) => setFieldP('sku', e.target.value)}
                      />
                    </Grid>
                    ...
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth required size="small">
                        ...
                        <Select label="Category" value={pForm.category_id} onChange={(e) => setFieldP('category_id', e.target.value)}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth required size="small">
                        ...
                        <Select label="Product Type" value={pForm.product_type} onChange={(e) => setFieldP('product_type', e.target.value)}>
                    ...
                    {pForm.product_type === 'simple' && (
                      <Grid item xs={12} sm={6}>
                        ...
                        <TextField
                          ...
                          value={pForm.price}
                          onChange={(e) => setFieldP('price', e.target.value)}
                        />
                      </Grid>
                    )}
                    ...
                    <Grid item xs={12}>
                      <TextField
                        ...
                        onChange={(e) => setFieldP('description', e.target.value)}
                      />
                    </Grid>
                          ...
                          <Grid container spacing={1.5} key={i} sx={{ mb: 1 }}>
                            ...
                            <Grid item xs={6} sm={2}>
                              <TextField
                                ...
                                onChange={(e) => updateVariation(i, 'stock_quantity', parseInt(e.target.value))}
                              />
                            </Grid>
                            <Grid item xs={6} sm={1}>
                              <Button color="error" size="small" onClick={() => removeVariation(i)}>
                                Remove
                              </Button>
                            </Grid>
                          </Grid>
                    ...
                    <Grid item xs={12}>
                      <Stack direction="row" spacing={1}>
                        ...
                        <Button variant="outlined" onClick={resetPForm}>
                          Cancel
                        </Button>
                      </Stack>
                    </Grid>
                    ...
                    <Stack direction="row" justifyContent="space-between" alignItems="flex-start" mb={1}>
                      ...
                      <Stack direction="row" spacing={0.5}>
                        <Tooltip title="Edit">
                          ...
                          <IconButton size="small" aria-label={`Edit ${p.name}`} onClick={() => navigate(`/manager/products/${p.id}/edit`)}>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                      <Stack direction="row" spacing={1}>
                        ...
                        <Button variant="outlined" onClick={resetCatForm}>
                          Cancel
                        </Button>
                      </Stack>
                    </Grid>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                      <Stack direction="row" spacing={1}>
                        ...
                        <Button variant="outlined" onClick={resetSubForm}>
                          Cancel
                        </Button>
                      </Stack>
                    </Grid>
                        ...
                        {subcategories
                          ...
                          .map((s) => (
                            <Chip
                              ...
                              onClick={() => {
                                setEditSub(s)
                                setSubForm({ category_id: s.category_id, name: s.name, description: s.description || '' })
                                setShowSubForm(true)
                              }}
                            />
                          ))}

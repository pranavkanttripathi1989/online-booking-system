...
const INITIAL = {
  ...
  date_of_birth: null, gender: '', address: '', notes: '',
}
...
export default function CreatePatientPage() {
  ...
  return (
    <Box className="page-enter">
      <Helmet><title>New Patient — MediBook</title></Helmet>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3, flexWrap: 'wrap' }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, flex: 1 }}>
          <Box sx={{ width: 40, height: 40, borderRadius: 2.5, background: 'linear-gradient(135deg,#E6F4EA,#B7DFC1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <PersonAddRoundedIcon sx={{ color: '#137333', fontSize: '1.2rem' }} />
          </Box>
          <Box>
            <Typography variant="h5" fontWeight={800} color="#202124">New Patient</Typography>
            <Typography variant="body2" color="text.secondary">Register a new patient record</Typography>
          </Box>
        </Box>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={8}>
          <Paper elevation={0} sx={{ p: 3, borderRadius: 3, border: '1px solid #E8EAED', mb: 3 }}>
            ...
            <Grid container spacing={2.5}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField fullWidth label="Email" type="email" value={form.email} onChange={set('email')} sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }} />
              </Grid>
              <Grid item xs={12} sm={6}>
              ...
              <Grid item xs={12}>
                <TextField fullWidth multiline rows={2} label="Address" value={form.address} onChange={set('address')} sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }} />
              </Grid>
              <Grid item xs={12}>
                <TextField fullWidth multiline rows={3} label="Clinical Notes" value={form.notes} onChange={set('notes')} sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }} />
              </Grid>
            </Grid>
          </Paper>
        </Grid>
        <Grid item xs={12} md={4}>
          <Paper elevation={0} sx={{ p: 3, borderRadius: 3, border: '1px solid #E8EAED', bgcolor: '#F8FDF9' }}>
            <Typography variant="subtitle1" fontWeight={700} color="#137333" mb={1}>Patient Record</Typography>

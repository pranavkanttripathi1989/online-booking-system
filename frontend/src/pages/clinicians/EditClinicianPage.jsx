...
const MOCK_EDIT_DATA = {
  c1: {
    ...
    gender: 'female',
    bio: 'Experienced General Practitioner with 10+ years in primary care.',
    consultation_fee: '80',
    is_active: true,
    clinician_type: { id: 'ct1', name: 'General Practitioner' },
    clinics: [{ id: 'cl1' }],
    services: [{ id: 'sv1' }, { id: 'sv2' }],
    languages: ['English'],
  },
  c2: {
    first_name: 'Carlos',
    ...
    gender: 'male',
    bio: 'Consultant Cardiologist specialising in interventional cardiology.',
  ...
  c4: {
    ...
    gender: 'male',
    bio: 'Cardiologist focusing on preventive cardiology.',
  ...
  c5: {
    ...
    gender: 'female',
    bio: 'Physiotherapist with a strong background in musculoskeletal rehabilitation.',
    consultation_fee: '70',
    is_active: true,
    clinician_type: { id: 'ct4', name: 'Physiotherapist' },
    clinics: [{ id: 'cl1' }],
    services: [{ id: 'sv7' }, { id: 'sv8' }],
    languages: ['English'],
  },
  c6: {
    first_name: 'Omar',
    ...
    gender: 'male',
    bio: 'Senior Radiologist specialised in CT and MRI imaging.',
    consultation_fee: '0',
    is_active: false,
  ...
  c7: {
    ...
    gender: 'female',
    bio: "GP with special interest in women's health and family medicine.",
    consultation_fee: '85',
    is_active: true,
    clinician_type: { id: 'ct1', name: 'General Practitioner' },
    clinics: [{ id: 'cl1' }],
  ...
  c8: {
    ...
    gender: 'female',
    bio: 'Consultant Dermatologist with expertise in skin cancer screening.',
    consultation_fee: '110',
    is_active: true,
    clinician_type: { id: 'ct6', name: 'Dermatologist' },
    clinics: [{ id: 'cl3' }],
    services: [{ id: 'sv9' }, { id: 'sv10' }],
    languages: ['English', 'Hindi'],
  },
}
...
function EditClinicianPageContent() {
  ...
  return (
    <Box className="page-enter">
      <Helmet>
        <title>Edit Clinician — MediBook</title>
      </Helmet>

      {/* Header */}
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3, flexWrap: 'wrap' }}>
        <IconButton
          onClick={() => navigate(`/clinicians/${id}`)}
          sx={{ bgcolor: 'action.hover', '&:hover': { bgcolor: 'action.selected' } }}
          aria-label="Back to clinician detail"
        >

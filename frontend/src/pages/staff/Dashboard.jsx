...
const RECENT_ACTIVITY = [
  { icon: <CheckCircleIcon sx={{ color: '#2DC653', fontSize: 18 }} />, text: 'Emma Wilson checked in for 10:00 appt',    time: '10 min ago' },
  { icon: <CancelIcon      sx={{ color: '#E63946', fontSize: 18 }} />, text: 'Omar Hassan cancelled 14:00 appointment',  time: '35 min ago' },
  { icon: <PersonIcon      sx={{ color: '#3A86FF', fontSize: 18 }} />, text: 'New patient Lily Chen registered',          time: '1h ago'    },
  { icon: <CheckCircleIcon sx={{ color: '#2DC653', fontSize: 18 }} />, text: 'James Brown confirmed tomorrow\'s session', time: '2h ago'    },
];
    ...
    <Box>
      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        {[
          ...
          { label: 'Checked In',           value: 3,   sub: 'Currently waiting',     color: '#2DC653', icon: <CheckCircleIcon /> },
                ...
                <Box key={label} sx={{ mb: 1.5 }}>
                  ...
                  <LinearProgress
                    ...
                    sx={{
                      ...
                      bgcolor: '#E8F8F9',
                      '& .MuiLinearProgress-bar': { bgcolor: used / total > 0.85 ? '#E63946' : '#006D77', borderRadius: 3 },
                    }}
                  />
                </Box>
              ))}

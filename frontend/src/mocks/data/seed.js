...
export const ORGANISATIONS = [
  {
    ...
    contact_email: 'admin@meridianhealth.in',
  ...
  {
    id: 'org-2',
    name: 'CityCore Medical',
    slug: 'citycore',
    plan: 'pro',
    active_clinics: 1,
    created_at: '2023-06-20T00:00:00Z',
    contact_email: 'admin@citycoremedical.in',
    onboarding_status: 'completed',
    onboarding_step: null,
    trial_ends_at: null,
    owner_user_id: 'usr-2',
  },
  {
    ...
    contact_email: 'admin@wellspringclinic.in',
    onboarding_status: 'completed',
    onboarding_step: null,
    trial_ends_at: null,
    owner_user_id: 'usr-3',
...
export const SUBSCRIPTION_PLANS = [
  {
    ...
    price_yearly: 2499000, // ₹2,499/mo, ₹24,990/yr
    max_clinics: 1,
    max_clinicians: 5,
  ...
  },
  {
    ...
    price_yearly: 6999000, // ₹6,999/mo, ₹69,990/yr
    max_clinics: 5,
    max_clinicians: 25,
    features: [
  ...
  },
  {
    ...
    name: 'Enterprise',
    price_monthly: null,
    price_yearly: null, // custom pricing — "Contact sales"
    max_clinics: null,
    max_clinicians: null,
    features: [
      'Unlimited clinics & clinicians',
      'Dedicated account manager',
      'Custom integrations',
      'Priority support & SLA',
      'GST-compliant multi-branch invoicing',
    ],
  },
]
...
export const CLINICS = [
  {
    ...
    organisation: { id: 'org-1', name: 'Meridian Health Group' },
    city: 'London',
  ...
  {
    id: 'cli-4',
    name: 'CityCore West End',
    organisation: { id: 'org-2', name: 'CityCore Medical' },
    city: 'London',
    address: '55 Wimpole Street',
    postcode: 'W1G 8YL',
    timezone: 'Europe/London',
    phone: '020 7946 0400',
    total_rooms: 3,
  ...
  {
    id: 'cli-5',
    name: 'Wellspring Primary',
    organisation: { id: 'org-3', name: 'Wellspring Clinic' },
    city: 'Bristol',
...
export const ROOMS = [
  {
    ...
    room_type: { id: 'rt-1', name: 'Consultation' },
    capacity: 2,
    floor: 1,
    is_active: true,
  },
  ...
  },
  {
    ...
    clinic: { id: 'cli-1', name: 'Meridian Central' },
    room_type: { id: 'rt-2', name: 'Procedure' },
    capacity: 3,
    floor: 2,
    is_active: true,
  },
  {
    ...
    room_type: { id: 'rt-3', name: 'Therapy' },
    capacity: 4,
    floor: 1,
    is_active: true,
  },
  ...
  },
  {
    ...
    clinic: { id: 'cli-5', name: 'Wellspring Primary' },
    room_type: { id: 'rt-1', name: 'Consultation' },
    capacity: 2,
    floor: 1,
    is_active: true,
  },
  {
    ...
    clinic: { id: 'cli-5', name: 'Wellspring Primary' },
    room_type: { id: 'rt-4', name: 'Paediatric' },
    capacity: 4,
    floor: 1,
    is_active: true,
  },
...
export const SERVICES = [
  {
    ...
    max_advance_days: 60,
    description:
      'Standard 15-minute GP consultation for registered patients. Covers symptom assessment, referrals, and repeat prescriptions.',
  ...
  },
  {
    ...
    revenue_month: 2240,
    max_advance_days: 60,
    description: 'Extended 30-minute GP consultation for complex or multi-issue presentations.',
    assigned_clinicians: ['cln-1', 'cln-2'],
  },
  {
    id: 'svc-3',
    ...
    revenue_month: 140,
    max_advance_days: 30,
    description: 'Quick blood pressure measurement and review by a nurse or GP.',
    assigned_clinicians: ['cln-1'],
  },
  {
    id: 'svc-4',
    ...
    revenue_month: 1820,
    max_advance_days: 45,
    description: 'One-to-one physiotherapy assessment and treatment session.',
    assigned_clinicians: ['cln-5', 'cln-7'],
  },
  {
    id: 'svc-5',
    ...
    revenue_month: 900,
    max_advance_days: 60,
    description: 'Comprehensive sports injury assessment with treatment plan.',
    assigned_clinicians: ['cln-5'],
  },
  {
    id: 'svc-6',
    name: 'Psychiatry Initial Consult',
    clinic: { id: 'cli-3', name: 'Meridian North' },
    duration_minutes: 60,
    price: 150,
    is_active: true,
    ...
    revenue_month: 2400,
    max_advance_days: 90,
    description: 'Initial psychiatric assessment covering mental health history and treatment planning.',
    assigned_clinicians: ['cln-6'],
  },
  {
    id: 'svc-7',
    name: 'CBT Session',
    ...
    revenue_month: 2640,
    max_advance_days: 60,
    description: 'Cognitive Behavioural Therapy session.',
    assigned_clinicians: ['cln-6', 'cln-9'],
  },
  {
    id: 'svc-8',
    ...
    revenue_month: 770,
    max_advance_days: 60,
    description: 'Dermatology skin assessment and treatment planning.',
    assigned_clinicians: ['cln-4'],
  },
  {
    id: 'svc-9',
    name: 'Acne Treatment',
    ...
    revenue_month: 960,
    max_advance_days: 60,
    description: 'Targeted acne treatment and medication review.',
    assigned_clinicians: ['cln-4'],
  },
  {
    id: 'svc-10',
    ...
    revenue_month: 1980,
    max_advance_days: 60,
    description: 'Comprehensive cardiovascular assessment including ECG and risk profiling.',
    assigned_clinicians: ['cln-3'],
  },
  {
    id: 'svc-11',
    name: 'Child Well-check',
    clinic: { id: 'cli-5', name: 'Wellspring Primary' },
    duration_minutes: 20,
    price: 35,
    is_active: true,
    ...
    revenue_month: 315,
    max_advance_days: 90,
    description: 'Routine well-child check including growth assessment and developmental screening.',
    assigned_clinicians: ['cln-8'],
  },
  {
    id: 'svc-12',
    ...
    revenue_month: 200,
    max_advance_days: 30,
    description: 'Scheduled vaccination administration per NHS or private programme.',
    assigned_clinicians: ['cln-8'],
  },
]
...
export const CLINICIANS = [
  {
    ...
    services: [
      { id: 'svc-1', name: 'GP Consultation' },
      { id: 'svc-2', name: 'Extended GP Consultation' },
      { id: 'svc-3', name: 'Blood Pressure Check' },
    ],
  },
  {
    id: 'cln-2',
  ...
  },
  {
    ...
    services: [
      { id: 'svc-6', name: 'Psychiatry Initial Consult' },
      { id: 'svc-7', name: 'CBT Session' },
    ],
  },
  {
    id: 'cln-7',

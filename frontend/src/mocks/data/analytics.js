...
export const REVIEWS = [
  {
    ...
    clinician_id: 'cln-5',
    clinician_name: 'Lucy Harrington',
    stars: 5,
    comment:
      'Lucy was absolutely fantastic. Very thorough and explained everything about my injury in detail. I feel confident in my recovery programme.',
    response: null,
  ...
  },
  {
    ...
    clinician_id: 'cln-7',
    clinician_name: 'Dr. Amara Diallo',
    stars: 4,
    comment: 'Good session overall. The wait time was a little long but Amara was very helpful once we got started.',
    response: "Thank you for your feedback. We're working on reducing wait times.",
    created_at: '2026-03-11T12:00:00Z',
  },
  {
    id: 'rev-3',
    appointment_id: 'appt-12',
    patient_id: 'pt-12',
    patient_name: 'Hassan Malik',
    clinician_id: 'cln-1',
    clinician_name: 'Dr. Sarah Mitchell',
    stars: 5,
    comment: 'Dr. Mitchell explained everything clearly and put me at ease. Quick and professional service.',
    response: null,
    created_at: '2026-03-06T09:00:00Z',
  },
  {
    id: 'rev-4',
    appointment_id: 'appt-14',
    patient_id: 'pt-14',
    patient_name: 'Roberto Silva',
    clinician_id: 'cln-3',
    clinician_name: 'Dr. Priya Sharma',
    stars: 4,
    comment: 'Very knowledgeable cardiologist. Felt reassured after the appointment. Only minor issue was parking.',
    response: null,
    created_at: '2026-03-05T14:00:00Z',
  },
  {
    id: 'rev-5',
    appointment_id: 'appt-18',
    patient_id: 'pt-18',
    patient_name: "Patrick O'Brien",
    clinician_id: 'cln-5',
    clinician_name: 'Lucy Harrington',
    stars: 5,
    comment: 'Excellent assessment. Lucy identified the issue immediately and outlined a clear treatment plan. Highly recommend.',
    response: null,
    created_at: '2026-03-03T11:00:00Z',
  },
  {
    id: 'rev-6',
    appointment_id: 'appt-20',
    patient_id: 'pt-1',
    patient_name: 'Alice Thompson',
    clinician_id: 'cln-1',
    clinician_name: 'Dr. Sarah Mitchell',
    stars: 5,
    comment: 'Always a pleasure to see Dr. Mitchell. She takes the time to listen and never makes you feel rushed.',
    response: null,
    created_at: '2025-12-11T10:00:00Z',
  },
  {
    id: 'rev-7',
    appointment_id: 'appt-21',
    patient_id: 'pt-20',
    patient_name: 'William Blackwood',
    clinician_id: 'cln-3',
    clinician_name: 'Dr. Priya Sharma',
    stars: 3,
    comment: 'Doctor was professional but felt the appointment was quite rushed. Could have explained the medication changes better.',
    response: "We're sorry to hear you felt rushed. We'll ensure more time is allocated. Thank you for letting us know.",
    created_at: '2026-02-19T11:00:00Z',
  },
  {
    id: 'rev-8',
    appointment_id: 'appt-25',
    patient_id: 'pt-24',
    patient_name: 'Finn Jacobsen',
    clinician_id: 'cln-5',
    clinician_name: 'Lucy Harrington',
    stars: 5,
    comment:
      "Session 4 and my shoulder is dramatically better. Lucy's approach is excellent and the exercises she gives are very manageable.",
    response: null,
    created_at: '2026-02-13T10:00:00Z',
  },
  {
    id: 'rev-9',
    appointment_id: 'appt-30',
    patient_id: 'pt-28',
    patient_name: 'Tom Andersson',
    clinician_id: 'cln-3',
    clinician_name: 'Dr. Priya Sharma',
    stars: 4,
    comment: 'Professional and thorough as always. Dr. Sharma takes a holistic view of cardiac health.',
    response: null,
    created_at: '2026-02-06T10:00:00Z',
  },
  {
    id: 'rev-10',
    appointment_id: 'appt-33',
    patient_id: 'pt-6',
    patient_name: 'Dmitri Volkov',
    clinician_id: 'cln-6',
    clinician_name: 'Dr. Ben Whitfield',
    stars: 5,
    comment: 'Dr. Whitfield has been transformative for my anxiety. CBT with him has given me real tools to manage my condition.',
    response: null,
  ...
  },
  {
    ...
    patient_name: 'George Williams',
    clinician_id: 'cln-2',
    clinician_name: 'Meridian East',
    stars: 2,
    comment: 'The clinic facilities could be improved. Waiting room was crowded.',
    response: "Thank you for your feedback. We're renovating Q2 2026.",
  ...
  },
  {
    ...
    clinician_name: 'Dr. Amara Diallo',
    stars: 4,
    comment: 'Dr. Diallo is clearly passionate about her patients. Very empathetic consultation.',
    response: null,
  ...
  },
  {
    ...
    clinician_name: 'Dr. Sarah Mitchell',
    stars: 5,
    comment: 'Outstanding care. 5 stars without hesitation.',
    response: null,
  ...
  },
  {
    ...
    clinician_name: 'Lucy Harrington',
    stars: 5,
    comment: "Best physio I've had. Already seeing results after 2 sessions.",
    response: null,
  ...
  },
  {
    ...
    clinician_name: 'Dr. Priya Sharma',
    stars: 3,
    comment: 'Good clinician, but waiting 20 minutes past appointment time was frustrating.',
    response: 'Apologies for the delay — we had an emergency earlier that day. Your patience is appreciated.',
...
export const INVOICES = [
  ...
  },
  {
    ...
    patient_id: 'pt-14',
    patient_name: 'Roberto Silva',
    service_name: 'Cardio Assessment',
    base_price: 110,
    products_total: 0,
    subtotal: 110,
    vat: 22.0,
  ...
  },
  {
    ...
    patient_id: 'pt-18',
    patient_name: "Patrick O'Brien",
    service_name: 'Sports Injury Assessment',
    base_price: 90,
    products_total: 22,
    subtotal: 112,
    vat: 22.4,
  ...
  },
  {
    ...
    patient_id: 'pt-1',
    patient_name: 'Alice Thompson',
    service_name: 'Extended GP Consultation',
    base_price: 70,
    products_total: 12,
    subtotal: 82,
    vat: 16.4,
...
export const CLINIC_BLOCKS = [
  ...
  { id: 'blk-4', clinic_id: 'cli-3', title: 'Staff Training Day', start_date: '2026-03-28', end_date: '2026-03-28', type: 'training' },
  {
    id: 'blk-5',
    clinic_id: 'cli-4',
    title: 'Derma Conference (half day)',
...
export const ROLES_PERMISSIONS = [
  ...
  {
    role: 'clinician',
    permissions: ['view_own_calendar', 'manage_own_availability', 'view_own_patients', 'message_patients', 'complete_appointments'],
  },
...
export const EMAIL_TEMPLATES = [
  {
    ...
    body: '<p>Dear {{patient_name}}, your appointment with {{clinician_name}} on {{date}} at {{time}} is confirmed.</p>',
  },
  {
    id: 'et-2',
    type: 'appointment_reminder',
    subject: 'Reminder: Your appointment tomorrow at {{time}}',
    body: '<p>Dear {{patient_name}}, this is a reminder of your appointment tomorrow at {{time}} with {{clinician_name}}.</p>',
  },
  {
    id: 'et-3',
    type: 'appointment_cancelled',
    subject: 'Your appointment has been cancelled',
    body: '<p>Dear {{patient_name}}, your appointment on {{date}} has been cancelled.</p>',
  },
  {
    id: 'et-4',
    type: 'appointment_rescheduled',
    subject: 'Your appointment has been rescheduled',
    body: '<p>Dear {{patient_name}}, your appointment has been rescheduled to {{new_date}} at {{new_time}}.</p>',
  },
  {
    id: 'et-5',
    type: 'welcome',
    subject: 'Welcome to MediBook',
    body: '<p>Welcome to MediBook, {{name}}! Your account is now active.</p>',
  },
  {
    id: 'et-6',
    type: 'password_reset',
    subject: 'Reset your MediBook password',
    body: '<p>Click <a href="{{reset_link}}">here</a> to reset your password. This link expires in 1 hour.</p>',
  },
]
...
export const POLICIES = [
  {
    ...
    content:
      'Appointments cancelled within 24 hours of the scheduled time may be subject to a cancellation fee equal to 50% of the service price.',
  ...
  },
  {
    ...
    name: 'No-Show Policy',
    content:
      'Patients who do not attend without prior cancellation will be recorded as a no-show. Two consecutive no-shows may result in a booking restriction.',
    updated_at: '2025-01-15T00:00:00Z',
  },
  {
    id: 'pol-3',
    name: 'Data Retention Policy',
    content: 'Patient records are retained for a minimum of 8 years in accordance with NHS and ICO guidelines.',
    updated_at: '2025-03-01T00:00:00Z',
  },
  {
    id: 'pol-4',
    name: 'Video Consultation Terms',
    content:
      'Video consultations are conducted via our secure platform. Recordings are not made. Both parties must be in a private location.',

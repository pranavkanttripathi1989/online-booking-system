...
license: MIT
metadata:
  upstream_risk_tag: offensive
  upstream_author: zebbern
  source: https://github.com/sickn33/antigravity-awesome-skills/blob/main/skills/top-web-vulnerabilities/SKILL.md
  source_repo: sickn33/antigravity-awesome-skills
  date_added: "2026-02-27"
  vetted: >-
    Reviewed 2026-08-18, part of the same 8-file batch review as
    api-security-best-practices (see that file for the shared batch note).
    upstream_risk_tag here is "offensive" (not "critical" like the others)
    — read in full before vendoring specifically because of that tag:
    content is a structured vulnerability *reference catalog*
    (identification/impact/remediation per category), not exploit code or
    live attack tooling — no payloads, no target-scanning scripts. Intended
    defensive use here: cross-checking this project's own APIs/auth against
    known vulnerability classes, same spirit as
    requirements/security-requirements.md's OWASP-grounded checklist.
---

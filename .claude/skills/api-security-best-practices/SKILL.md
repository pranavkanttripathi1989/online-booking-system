...
metadata:
  ...
  source: https://github.com/sickn33/antigravity-awesome-skills/blob/main/skills/api-security-best-practices/SKILL.md
  source_repo: sickn33/antigravity-awesome-skills
  date_added: "2026-02-27"
  vetted: >-
    Reviewed 2026-08-18, batch review with security-review/error-handling/
    api-design/top-web-vulnerabilities/code-review-checklist/
    secrets-management/typescript-expert: grepped all 8 for injection/
    exfiltration/exec patterns first (clean — illustrative fetch() snippets
    only), then spot-checked each for relevance. Source repo (sickn33/
    antigravity-awesome-skills, MIT-licensed, 45k+ stars, verified via the
    GitHub API) — same publisher already vetted for graphql-architect.
    upstream_risk_tag preserved (not dropped) as a review-before-applying
    signal, same treatment as graphql-architect. Directly relevant: this
    backend's JWT/guard/rate-limiting (@Throttle, GqlAuthGuard, RolesGuard)
    is exactly this skill's subject matter.
---

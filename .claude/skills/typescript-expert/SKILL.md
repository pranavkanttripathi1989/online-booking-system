...
metadata:
  ...
  source: https://github.com/sickn33/antigravity-awesome-skills/blob/main/skills/typescript-expert/SKILL.md
  ...
  vetted: >-
    ...
    Directly relevant — both backend (NestJS) and frontend (React) here are
    TypeScript. Monorepo-management sections are aspirational (this is a
    two-app repo with separate backend/frontend package.json files, not a
    formal monorepo tool like Nx/Turborepo), the rest applies directly.
---

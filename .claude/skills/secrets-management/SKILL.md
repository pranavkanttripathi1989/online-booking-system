...
metadata:
  ...
  source: https://github.com/sickn33/antigravity-awesome-skills/blob/main/skills/secrets-management/SKILL.md
  ...
  vetted: >-
    ...
    Weakest fit of the eight: this project currently uses plain .env files
    (backend-hard-rules.md Rule 6 — fail closed on change-me-pattern
    secrets in non-dev NODE_ENV), not Vault/AWS Secrets Manager/CI-pipeline
    secret injection. Kept as forward-looking reference for if/when this
    project adopts a real secrets manager for production, not a description
    of its current secrets handling.
---

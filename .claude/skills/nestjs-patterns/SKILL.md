...
metadata:
  origin: ECC
  source: https://github.com/affaan-m/ECC/blob/main/skills/nestjs-patterns/SKILL.md
  license: MIT
  vetted: >-
    ...
    prompt-injection patterns. Source repo (affaan-m/ECC, MIT-licensed)
    verified directly via the GitHub API, not by self-reported metadata from
    a third-party skill marketplace (SkillHub's own grade/score fields were
    unpopulated for every skill checked, and its install command has no
    working artifact for this or ~120 other searched skills as of this date
    — content pulled from source instead).
---

...
current_slice:  P1-06            # first unstarted slice in that doc's tracker
last_completed: REQ148           # P1-05 (slot hold + booking idempotency, BOOK-2/BOOK-3) closed 2026-08-27
blocked_on:     none
```

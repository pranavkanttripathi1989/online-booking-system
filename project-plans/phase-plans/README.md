...
current_slice:  P2-13            # next unstarted, unblocked slice — P2-01 depends on blocked P1-10; P2-02..P2-12 done (P2-07 shipped allergy-only; P2-08 shipped English/Hindi only; P2-09 shipped all 6 offered languages, not just 3, per explicit user selection, see REQ161; P2-10 shipped as a new AppointmentSeries domain, see REQ163; P2-11 shipped as a new ImmunizationScheduleItems/ImmunizationRecords domain, see REQ167; P2-12 shipped as a new ChronicRegistryEnrollments domain, see REQ168)
last_completed: REQ168           # P2-12 (chronic-disease registries + recall) closed 2026-08-30
